...
var commands = []command{
	...
	{name: "pg", args: "[backups | backup [database] | restore <backup-id> [--target name] [--force] | drop <database> --confirm <database>]", group: "PostgreSQL", summary: "inspect the host PostgreSQL, list backups, run one, restore one, or drop a database",
